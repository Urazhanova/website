...
import { ArrowLeft, Quote, MapPin, Globe, Users } from "lucide-react";
...
const Leader = () => {
    return (
        <div className="min-h-screen bg-background font-sans selection:bg-primary/10">
            ...
            <section className="relative h-[80vh] min-h-[600px] flex items-end pb-20 overflow-hidden">
                ...
                <div className="container relative z-10 mx-auto px-4 lg:px-6">
                    <div className="max-w-4xl animate-in fade-in slide-in-from-bottom-8 duration-1000">
                        <Badge className="mb-6 bg-white/10 text-white border-white/20 backdrop-blur-md hover:bg-white/20">
                            Lead Trainer
                        </Badge>
                        <h1 className="text-6xl lg:text-8xl font-bold text-white font-heading tracking-tight mb-6">
                            Nikita Menshov
                        </h1>
                ...
                <div className="container mx-auto px-4 lg:px-6">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 h-[600px]">
                        <div className="col-span-2 row-span-2 relative rounded-2xl overflow-hidden group">
                            <img src="/assets/speaker-stage.jpg" alt="Speaking on stage" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                            <div className="absolute inset-0 bg-black/20 group-hover:bg-transparent transition-colors duration-500"></div>
                        </div>
                        <div className="col-span-1 row-span-1 relative rounded-2xl overflow-hidden group">
                            <img src="/assets/hero-speaker.jpg" alt="Workshop session" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                        </div>
                        <div className="col-span-1 row-span-2 relative rounded-2xl overflow-hidden group">
                            <img src="/assets/coach-portrait.jpg" alt="Portrait" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                        </div>
                        <div className="col-span-1 row-span-1 relative rounded-2xl overflow-hidden bg-primary/10 flex items-center justify-center">
                ...
                <div className="container mx-auto px-4 lg:px-6">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="relative">
                            <div className="absolute -inset-4 bg-gradient-to-br from-blue-100 to-transparent rounded-3xl -z-10"></div>
                            <Card className="p-8 lg:p-10 border-none shadow-xl bg-white">
            ...
            <section className="py-20 bg-heading text-white overflow-hidden">
                    ...
                    <div className="animate-marquee whitespace-nowrap flex gap-4">
                        {[1, 2, 3, 4].map((i) => (
                            <div key={i} className="flex gap-4">
                                <img src="/assets/speaker-stage.jpg" className="h-64 w-96 object-cover rounded-xl opacity-60 hover:opacity-100 transition-opacity duration-300" />
                                <img src="/assets/hero-speaker.jpg" className="h-64 w-96 object-cover rounded-xl opacity-60 hover:opacity-100 transition-opacity duration-300" />
                                <img src="/assets/coach-portrait.jpg" className="h-64 w-96 object-cover rounded-xl opacity-60 hover:opacity-100 transition-opacity duration-300" />
                            </div>
                        ))}
                    </div>
                ...
                <div className="container mx-auto px-4 lg:px-6 mt-12 grid md:grid-cols-3 gap-8 text-center">
                ...
                <div className="container mx-auto px-4 lg:px-6 text-center">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="inline-block relative group">
                            ...
                            <ContactModal>
                                <Button size="lg" className="relative bg-white text-heading hover:bg-gray-50 rounded-full h-16 px-12 text-xl font-bold shadow-xl border border-gray-100">
